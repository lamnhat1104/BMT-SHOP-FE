      ...
      <div className="h-64 flex flex-col justify-end pt-5 relative">
        ...
        <div className="flex justify-around items-end h-full px-4 z-10">
          {revenueData.map((d, index) => {
            ...
            return (
              <div key={index} className="flex flex-col items-center group/bar w-12 sm:w-16">
                {/* Tooltip */}
                ...
                <div 
                  ...
                  className="w-full bg-linear-to-t from-(--primary-color) to-orange-400 rounded-t-lg transition-all duration-500 hover:brightness-105 shadow-[0_4px_10px_rgba(244,121,32,0.15)]"
                ></div>
